...
object MockData {
    ...
    /**
     * Демо-кошелёк баллов для офлайн-режима (`AppConfig.useFirebase == false`):
     * без него экран баллов в демо пустой и его невозможно посмотреть.
     */
    val pointsCards: List<VenuePointsCard> = listOf(
        VenuePointsCard("navat", "Navat", balance = 320, lifetimeEarned = 540, lifetimeRedeemed = 220),
        VenuePointsCard("sierra", "Sierra Coffee", balance = 85, lifetimeEarned = 85),
    )
