...
public enum MockData {
    ...
    // MARK: - Баллы САН (демо-кошелёк для офлайн-режима)

    /// Показывается, когда `AppConfig.useFirebase == false`: без этого экран
    /// баллов в демо-режиме пустой и его невозможно посмотреть.
    public static let pointsCards: [VenuePointsCard] = [
        VenuePointsCard(venueID: "navat", venueName: "Navat",
                        balance: 320, lifetimeEarned: 540, lifetimeRedeemed: 220),
        VenuePointsCard(venueID: "sierra", venueName: "Sierra Coffee",
                        balance: 85, lifetimeEarned: 85),
    ]
    ...
    public static let venues: [Venue] = [
        Venue(id: "navat", name: "Navat", category: .teahouse, district: "Центр",
              ...
              gradient: [0xE65C00, 0xF9D423], imageURL: nil,
        ...
        Venue(id: "faiza", name: "Faiza", category: .cafe, district: "Восток-5",
              ...
              gradient: [0x11998E, 0x38EF7D], imageURL: nil,
        ...
        Venue(id: "sierra", name: "Sierra Coffee", category: .coffee, district: "Центр",
              ...
              gradient: [0x5D4157, 0xA8CABA], imageURL: nil,
        ...
        Venue(id: "bublik", name: "Bublik", category: .bakery, district: "Центр",
              ...
              gradient: [0xF7971E, 0xFFD200], imageURL: nil,
        ...
        Venue(id: "furusato", name: "Furusato", category: .restaurant, district: "Центр",
              ...
              gradient: [0xC31432, 0x240B36], imageURL: nil,
        ...
        Venue(id: "chickenstar", name: "Chicken Star", category: .fastfood, district: "Центр",
              ...
              gradient: [0xF12711, 0xF5AF19], imageURL: nil,
        ...
        Venue(id: "cyclone", name: "Cyclone", category: .restaurant, district: "Центр",
              ...
              gradient: [0x355C7D, 0xC06C84], imageURL: nil,
        ...
        Venue(id: "adriano", name: "Adriano Coffee", category: .coffee, district: "Моссовет",
              ...
              gradient: [0x3E5151, 0xDECBA4], imageURL: nil,
        ...
        Venue(id: "arzu", name: "Арзу", category: .cafe, district: "Юг-2",
              ...
              gradient: [0x870000, 0x190A05], imageURL: nil,
        ...
        Venue(id: "shaurma1", name: "Шаурма №1", category: .fastfood, district: "Аламедин-1",
              ...
              gradient: [0x636FA4, 0xE8CBC0], imageURL: nil,
    ...
    public static let deals: [Deal] = [
        Deal(id: "d1", venueID: "navat", type: .discount,
             ...
             terms: ["Каждый день до 12:00",
                     "Один напиток на гостя",
                     "Не суммируется с баллами САН"]),
    ...
    public static func venue(for deal: Deal) -> Venue {
        venues.first { $0.id == deal.venueID } ?? venues[0]
    }

    public static func deals(for venue: Venue) -> [Deal] {
        deals.filter { $0.venueID == venue.id && $0.isActive }
    }

    public static var activeDeals: [Deal] {
        deals.filter(\.isActive).sorted { $0.validUntil < $1.validUntil }
    }

    public static func deal(by id: String) -> Deal? {
        deals.first { $0.id == id }
    }
}
